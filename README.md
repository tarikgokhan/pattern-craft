...
| 31 | Application Design Patterns | .NET Application Patterns | **Specification Pattern** | İş kurallarını tekrar kullanılabilir koşullar olarak tanımlar. | [Specification Pattern](docs/application/dotnet-application/specification-pattern.md) |
