...
Talep, onaylar ve durum geçişleri tek tutarlılık sınırı içinde yönetilir.
...
`Request` aggregate root, ilişkili entity ve value object’lerin değişimini kontrol eder.
