...
| Dosya Yolu | `docs/microservice/api-access/gateway-routing.md` |
...
Gateway Routing, gelen istekleri ilgili mikroservise yönlendirir.
...
`/requests` çağrısı RequestService’e, `/reports` çağrısı ReportingService’e yönlendirilir.
...
Gateway’in en temel sorumluluğudur.
