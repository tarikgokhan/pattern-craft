...
| Pattern | API Gateway |
| Dosya Yolu | `docs/microservice/api-access/api-gateway.md` |
...
API Gateway, client uygulamalar için tek giriş noktası sağlar.
...
Web, mobile ve admin client’lar doğrudan servislere gitmeden gateway üzerinden yönlendirilir.
...
Routing, authentication, rate limit ve logging gibi ortak konuları merkezileştirir.
