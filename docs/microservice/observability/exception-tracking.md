...
| Dosya Yolu | `docs/microservice/observability/exception-tracking.md` |
...
Exception Tracking, hataları merkezi olarak takip etmeyi sağlar.
...
Beklenmeyen hatalar merkezi olarak gruplanır, izlenir ve alarm üretir.
...
Log ile birlikte stack trace, correlation id ve environment bilgisi tutulur.
...
```text
Exception -> Tracking Platform -> Alert
```
