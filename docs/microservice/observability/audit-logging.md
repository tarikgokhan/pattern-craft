...
| Dosya Yolu | `docs/microservice/observability/audit-logging.md` |
...
Audit Logging, kritik iş olaylarını denetlenebilir şekilde kaydeder.
...
Kim, ne zaman, hangi talep üzerinde hangi aksiyonu yaptı bilgisi denetlenebilir şekilde saklanır.
...
İş olaylarının değiştirilemez ve sorgulanabilir kaydıdır.
...
```text
Business Action -> Audit Entry -> Audit Store
```
