...
| Dosya Yolu | `docs/microservice/observability/application-metrics.md` |
...
Application Metrics, uygulama ve sistem metriklerini toplar.
...
Request count, latency, error rate ve domain metrikleri izlenir.
...
Sistem sağlığı metriklerle ölçülebilir hale gelir.
...
```text
Service -> Metrics Exporter -> Monitoring
```
