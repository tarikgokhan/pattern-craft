...
| Dosya Yolu | `docs/microservice/modernization/strangler-fig.md` |
...
Strangler Fig, legacy sistemi parça parça yeni yapıya taşır.
...
Eski sistem tek seferde değiştirilmez; fonksiyonlar adım adım yeni servislere taşınır.
...
Riskli büyük dönüşümleri küçük ve yönetilebilir parçalara böler.
...
```text
Legacy Function -> New Service -> Gradual Cutover
```
