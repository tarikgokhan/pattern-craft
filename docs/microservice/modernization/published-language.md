...
| Dosya Yolu | `docs/microservice/modernization/published-language.md` |
...
Published Language, sistemler arası ortak sözleşme dili oluşturur.
...
Sistemler arası iletişim için ortak terimler, event isimleri ve contract dili belirlenir.
...
Yanlış anlamaları ve model uyuşmazlıklarını azaltır.
...
```text
Shared Contract Language -> API + Events
```
