...
| Dosya Yolu | `docs/microservice/modernization/anti-corruption-layer.md` |
...
Anti-Corruption Layer, farklı model kullanan sistemler arasında koruyucu çeviri katmanı sağlar.
...
Eski veya farklı model kullanan sistemin kavramları domain modelini kirletmez.
...
Adapter, translator ve facade bileşenleriyle uygulanır.
...
```text
External Model -> ACL -> Internal Domain Model
```
