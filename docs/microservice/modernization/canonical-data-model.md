...
| Dosya Yolu | `docs/microservice/modernization/canonical-data-model.md` |
...
Canonical Data Model, sistemler arası ortak veri modeli oluşturur.
...
Birden fazla sistemle entegrasyonda ortak veri dili tanımlanır.
...
Her sistemin modelini doğrudan her sisteme yaymak yerine ortak contract kullanılır.
...
```text
System A Model -> Canonical Model -> System B Model
```
