...
| Alt Kategori | Modernization Patterns |
| Pattern | Open Host Service |
| Dosya Yolu | `docs/microservice/modernization/open-host-service.md` |
...
Open Host Service, domain kabiliyetlerini dış sistemlere kontrollü API ile açar.
...
Domain kabiliyetleri dış sistemlere kontrollü, versiyonlu ve dokümante API ile açılır.
...
Public contract, authentication, authorization ve rate limit birlikte ele alınır.
...
```text
Domain Capability -> Published API
```
