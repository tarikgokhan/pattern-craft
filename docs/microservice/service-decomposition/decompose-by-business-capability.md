...
| Alt Kategori | Service Decomposition Patterns |
| Pattern | Decompose by Business Capability |
| Dosya Yolu | `docs/microservice/service-decomposition/decompose-by-business-capability.md` |
...
Decompose by Business Capability, servisleri iş kabiliyetlerine göre böler.
...
Talep Yönetimi, Onay Yönetimi, Bildirim, Raporlama ve Audit gibi iş kabiliyetleri ayrı servis adayları olarak ele alınır.
...
Business capability map çıkarılır, servis sınırları teknik tablolara göre değil iş yeteneklerine göre belirlenir.
...
```text
Request Management -> Approval Management -> Notification -> Reporting
```
