...
| Dosya Yolu | `docs/microservice/service-decomposition/decompose-by-subdomain.md` |
...
Decompose by Subdomain, servisleri DDD subdomain sınırlarına göre böler.
...
Domain modelleme sonucunda core, supporting ve generic subdomain ayrımı yapılır.
...
DDD discovery çalışmaları, event storming ve bounded context analizleriyle uygulanır.
...
```text
Core Subdomain -> Request Workflow | Supporting -> Reporting | Generic -> Notification
```
