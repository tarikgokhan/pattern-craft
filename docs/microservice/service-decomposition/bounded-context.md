...
| Dosya Yolu | `docs/microservice/service-decomposition/bounded-context.md` |
...
Bounded Context, domain modelinin geçerli olduğu sınırı netleştirir.
...
Talep, onay, bildirim ve raporlama kavramlarının her bağlamda aynı anlama gelmeyebileceği kabul edilir.
...
Her bounded context kendi dilini, veri modelini ve kurallarını korur.
...
```text
Request Context != Reporting Context != Notification Context
```
