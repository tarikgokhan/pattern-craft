...
| Dosya Yolu | `docs/microservice/resilience/circuit-breaker.md` |
...
Circuit Breaker, hatalı servise sürekli çağrı yapılmasını engeller.
...
Sürekli hata veren dış sistem çağrıları belirli süre durdurulur.
...
Sistemin kaynaklarını korur ve hızlı fail davranışı sağlar.
