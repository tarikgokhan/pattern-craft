...
| Alt Kategori | Resilience Patterns |
| Pattern | Rate Limiting |
| Dosya Yolu | `docs/microservice/resilience/rate-limiting.md` |
...
Rate Limiting, belirli zaman aralığında yapılabilecek istek sayısını sınırlar.
...
Public API veya admin endpointleri için belirli zaman aralığında istek sınırı uygulanır.
...
Sistemi kötüye kullanım ve ani yoğunluktan korur.
