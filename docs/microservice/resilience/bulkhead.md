...
| Pattern | Bulkhead |
| Dosya Yolu | `docs/microservice/resilience/bulkhead.md` |
...
Bulkhead, kaynakları izole ederek hatanın tüm sisteme yayılmasını önler.
...
Raporlama, bildirim ve dış entegrasyon kaynakları birbirinden izole edilir.
...
Bir alandaki yavaşlık diğer alanları düşürmez.
