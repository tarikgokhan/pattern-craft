...
| Pattern | Throttling |
| Dosya Yolu | `docs/microservice/resilience/throttling.md` |
...
Throttling, yoğunluk durumunda sistemi korumak için istekleri yavaşlatır veya reddeder.
...
Yoğunluk anında istekler yavaşlatılır veya kontrollü reddedilir.
...
Sistemin tamamen çökmesini önler.
...
```text
High Load -> Throttle -> Stable System
```
