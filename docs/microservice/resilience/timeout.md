...
| Pattern | Timeout |
| Dosya Yolu | `docs/microservice/resilience/timeout.md` |
...
Timeout, servis çağrıları için maksimum bekleme süresi belirler.
...
Her dış çağrı için maksimum bekleme süresi tanımlanır.
...
Thread ve connection tüketimini kontrol altında tutar.
