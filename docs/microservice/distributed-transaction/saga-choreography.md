...
| Dosya Yolu | `docs/microservice/distributed-transaction/saga-choreography.md` |
...
Saga Choreography, servislerin event’lerle birbirini tetiklediği saga yaklaşımıdır.
...
Servisler merkezi orchestrator olmadan olaylarla birbirini tetikler.
...
Basit ve gevşek bağlı akışlarda kullanılabilir.
...
```text
RequestSubmitted -> ApprovalStarted -> NotificationPrepared
```
