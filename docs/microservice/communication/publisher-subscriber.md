...
| Dosya Yolu | `docs/microservice/communication/publisher-subscriber.md` |
...
Publisher / Subscriber, bir olayın birden fazla abone servis tarafından dinlenmesini sağlar.
...
Aynı talep olayı audit, bildirim ve raporlama tarafından ayrı ayrı dinlenir.
...
Yeni consumer eklemek ana servisi değiştirmeden mümkün olur.
...
```text
RequestSubmittedEvent -> Audit + Notification + Reporting
```
