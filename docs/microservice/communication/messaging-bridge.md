...
| Dosya Yolu | `docs/microservice/communication/messaging-bridge.md` |
...
Messaging Bridge, farklı mesajlaşma sistemleri arasında köprü kurar.
...
Farklı ekiplerin kullandığı iki message broker veya topic yapısı arasında olay aktarımı yapılabilir.
...
Geçiş ve entegrasyon dönemlerinde kullanılır.
