...
| Dosya Yolu | `docs/microservice/infrastructure/service-mesh.md` |
...
Service Mesh, servisler arası trafiği platform seviyesinde yönetir.
...
Servisler arası trafik sidecar proxy’ler ve control plane ile yönetilir.
...
mTLS, routing, tracing ve policy uygulama kodundan bağımsızlaşır.
