...
| Dosya Yolu | `docs/microservice/infrastructure/service-discovery.md` |
...
Service Discovery, servislerin dinamik olarak birbirini bulmasını sağlar.
...
Servis adresleri statik konfigürasyona gömülmeden dinamik olarak bulunur.
...
Container ve orchestrator ortamlarında temel altyapı desenidir.
...
```text
Service Name -> Registry / Platform DNS -> Endpoint
```
