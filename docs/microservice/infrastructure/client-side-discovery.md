...
| Dosya Yolu | `docs/microservice/infrastructure/client-side-discovery.md` |
...
Client-side Discovery, client’ın hedef servis adresini registry üzerinden bulmasıdır.
...
Client, registry’den hedef servisin adresini alır ve çağrıyı kendisi yapar.
...
Registry bağımlılığı client tarafına taşınır.
