...
| Pattern | Sidecar |
| Dosya Yolu | `docs/microservice/infrastructure/sidecar.md` |
...
Sidecar, ana uygulamanın yanında yardımcı container/process çalıştırır.
...
Ana uygulamanın yanında log agent, telemetry collector veya proxy gibi yardımcı process/container çalışır.
...
Ortak altyapı davranışları uygulama kodundan ayrılır.
