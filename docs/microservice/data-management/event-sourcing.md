...
| Dosya Yolu | `docs/microservice/data-management/event-sourcing.md` |
...
Event Sourcing, son durum yerine olay geçmişini saklar.
...
Talebin son durumu yerine RequestCreated, RequestSubmitted, RequestApproved gibi olayların geçmişi saklanır.
...
Audit yoğun ve geçmişin doğrulanması gereken sistemlerde değerlendirilir.
...
```text
Event Stream -> Projection -> Current State
```
