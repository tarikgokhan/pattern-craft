...
| Dosya Yolu | `docs/microservice/data-management/materialized-view.md` |
...
Materialized View, okuma performansı için hazır okuma modeli oluşturur.
...
Raporlama ekranları için talep özetleri önceden hazırlanmış read model üzerinde tutulur.
...
Event consumer, gelen olaylarla read model’i günceller.
...
```text
RequestApprovedEvent -> RequestSummaryReadModel
```
